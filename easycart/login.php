    ...
    <main class="main">
        <div class="container">
            <section class="section">
                <form class="form">
                    <h2 style="text-align: center; margin-bottom: var(--space-6);">Login to EasyCart</h2>
                    ...
                    <div class="form__group">
                        ...
                        <input type="password" class="form__input" placeholder="Enter your password" required>
                    </div>
                    <div class="form__actions">
                        <button type="submit" class="btn btn--primary btn--full">Login</button>
                    </div>
                    <div style="text-align: center; margin-top: var(--space-4);">
                        <p>Don't have an account? <a href="signup.php" class="form__link">Sign up</a></p>
                    </div>
                </form>
            </section>
        </div>
